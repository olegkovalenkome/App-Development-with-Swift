...
func checkMeals(_ meal: String) -> Meal? {
 ...
 */
//UserDefaults.standard.dictionary(forKey: "Breakfast")
//
//func checkMealsInMomory(meal: String) -> [String: Any]? {
...
//}
//
//print(checkMealsInMomory(meal: "Breakfast")
