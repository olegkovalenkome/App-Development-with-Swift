 ...
 */
let userInputAge: String = "17"

func checkAge(age: String) {
    let checkingAge: Int? = Int(age)
    if checkingAge != nil {
        if checkingAge! >= 18 {
            print("Welcome!")
        } else {
...
var stock = ["Chips": 4, "Donuts": 10, "Juice": 12, "Apple": 6, "Banana": 6, "Broccoli": 3]

print(stock.keys.contains("Chips"))
stock["Chips"]

func checkItemsCostBy(name: String) -> Double {
