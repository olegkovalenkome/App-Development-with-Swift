...
var distroyer = Fighter()
distroyer.name = "Distroyer"
distroyer.health = 100
distroyer.position = -2
distroyer.remainingFirePower = 10
distroyer.weapon = "Laser"
distroyer.moveRight()
print(distroyer.position)
/*:
...
distroyer.fire()
distroyer.fire()
print(distroyer.remainingFirePower)
