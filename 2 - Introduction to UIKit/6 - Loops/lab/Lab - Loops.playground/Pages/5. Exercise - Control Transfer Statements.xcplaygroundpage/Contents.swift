...
var places = ["USA": "San Francisco", "Greate Britan": "London", "Ukraine": "Odessa", "Russia": "Moscow"]

for (countri, city) in places {
    print(countri, city)
    if countri == "Ukraine" && city == "Odessa" {
        print("I found home")
        break
    }
}
